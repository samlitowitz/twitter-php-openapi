...
/**
 * CashtagEntity Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CashtagEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashtagEntity';
    ...
    public function setEnd($end)
    {
        ...
        if (($end < 0)) {
            throw new \InvalidArgumentException('invalid value for $end when calling CashtagEntity., must be bigger than or equal to 0.');
        }
    ...
    public function setStart($start)
    {
        ...
        if (($start < 0)) {
            throw new \InvalidArgumentException('invalid value for $start when calling CashtagEntity., must be bigger than or equal to 0.');
        }
