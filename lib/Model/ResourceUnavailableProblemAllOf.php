...
/**
 * ResourceUnavailableProblemAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResourceUnavailableProblemAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceUnavailableProblem_allOf';
    ...
    public function setParameter($parameter)
    {
        ...
        if ((mb_strlen($parameter) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parameter when calling ResourceUnavailableProblemAllOf., must be bigger than or equal to 1.');
        }
