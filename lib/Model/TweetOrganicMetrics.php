...
/**
 * TweetOrganicMetrics Class Doc Comment
 *
 * @category Class
 ...
 */
class TweetOrganicMetrics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tweet_organic_metrics';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['impression_count'] === null) {
            $invalidProperties[] = "'impression_count' can't be null";
        }
        ...
        if ($this->container['retweet_count'] === null) {
            $invalidProperties[] = "'retweet_count' can't be null";
        }
