...
/**
 * EntityIndicesInclusiveInclusive Class Doc Comment
 *
 * @category Class
 ...
 */
class EntityIndicesInclusiveInclusive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntityIndicesInclusiveInclusive';
    ...
    public function setEnd($end)
    {
        ...
        if (($end < 0)) {
            throw new \InvalidArgumentException('invalid value for $end when calling EntityIndicesInclusiveInclusive., must be bigger than or equal to 0.');
        }
    ...
    public function setStart($start)
    {
        ...
        if (($start < 0)) {
            throw new \InvalidArgumentException('invalid value for $start when calling EntityIndicesInclusiveInclusive., must be bigger than or equal to 0.');
        }
