...
class Variant implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets bit_rate
     *
     * @param int|null $bit_rate The bit rate of the media.
     *
     * @return self
     */
     ...
     * Sets content_type
     *
     * @param string|null $content_type The content type of the media.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The url to the media.
     *
     * @return self
     */
