...
/**
 * ClientForbiddenProblemAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientForbiddenProblemAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientForbiddenProblem_allOf';
    ...
    public const REASON_OFFICIAL_CLIENT_FORBIDDEN = 'official-client-forbidden';
    public const REASON_CLIENT_NOT_ENROLLED = 'client-not-enrolled';
