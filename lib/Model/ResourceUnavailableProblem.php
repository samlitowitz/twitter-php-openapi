...
class ResourceUnavailableProblem extends Problem
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceUnavailableProblem';
    ...
    public function setParameter($parameter)
    {
        ...
        if ((mb_strlen($parameter) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parameter when calling ResourceUnavailableProblem., must be bigger than or equal to 1.');
        }
