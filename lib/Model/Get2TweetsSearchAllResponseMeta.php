 ...
 */
class Get2TweetsSearchAllResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Get2TweetsSearchAllResponse_meta';
    ...
    public function setNextToken($next_token)
    {
        ...
        if (!is_null($next_token) && (mb_strlen($next_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_token when calling Get2TweetsSearchAllResponseMeta., must be bigger than or equal to 1.');
        }
