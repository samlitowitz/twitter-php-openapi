...
/**
 * TweetCreateResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TweetCreateResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TweetCreateResponse_data';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9]{1,19}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling TweetCreateResponseData., must conform to the pattern /^[0-9]{1,19}$/.");
        }
