 ...
 */
class Get2UsersIdMentionsResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Get2UsersIdMentionsResponse_meta';
    ...
    public function setNextToken($next_token)
    {
        ...
        if (!is_null($next_token) && (mb_strlen($next_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_token when calling Get2UsersIdMentionsResponseMeta., must be bigger than or equal to 1.');
        }
    ...
    public function setPreviousToken($previous_token)
    {
        ...
        if (!is_null($previous_token) && (mb_strlen($previous_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $previous_token when calling Get2UsersIdMentionsResponseMeta., must be bigger than or equal to 1.');
        }
