...
/**
 * MentionEntity Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MentionEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MentionEntity';
    ...
    public function setEnd($end)
    {
        ...
        if (($end < 0)) {
            throw new \InvalidArgumentException('invalid value for $end when calling MentionEntity., must be bigger than or equal to 0.');
        }
    ...
    public function setStart($start)
    {
        ...
        if (($start < 0)) {
            throw new \InvalidArgumentException('invalid value for $start when calling MentionEntity., must be bigger than or equal to 0.');
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9]{1,19}\\z/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling MentionEntity., must conform to the pattern /^[0-9]{1,19}\\z/.");
        }
    ...
    public function setUsername($username)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9_]{1,15}$/", $username))) {
            throw new \InvalidArgumentException("invalid value for $username when calling MentionEntity., must conform to the pattern /^[A-Za-z0-9_]{1,15}$/.");
        }
