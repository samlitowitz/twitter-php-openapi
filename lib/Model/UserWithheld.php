...
/**
 * UserWithheld Class Doc Comment
 *
 * @category Class
 ...
 */
class UserWithheld implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserWithheld';
    ...
    public function setCountryCodes($country_codes)
    {
        ...
        if ((count($country_codes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country_codes when calling UserWithheld., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets scope
     *
     * @param string|null $scope Indicates that the content being withheld is a `user`.
     *
     * @return self
     */
