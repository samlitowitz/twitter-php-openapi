...
/**
 * UserEntitiesUrl Class Doc Comment
 *
 * @category Class
 ...
 */
class UserEntitiesUrl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_entities_url';
    ...
    public function setUrls($urls)
    {
        ...
        if (!is_null($urls) && (count($urls) < 1)) {
            throw new \InvalidArgumentException('invalid length for $urls when calling UserEntitiesUrl., number of items must be greater than or equal to 1.');
        }
