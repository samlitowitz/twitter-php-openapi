...
/**
 * HashtagEntity Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HashtagEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HashtagEntity';
    ...
    public function setEnd($end)
    {
        ...
        if (($end < 0)) {
            throw new \InvalidArgumentException('invalid value for $end when calling HashtagEntity., must be bigger than or equal to 0.');
        }
    ...
    public function setStart($start)
    {
        ...
        if (($start < 0)) {
            throw new \InvalidArgumentException('invalid value for $start when calling HashtagEntity., must be bigger than or equal to 0.');
        }
     ...
     * Sets tag
     *
     * @param string $tag The text of the Hashtag.
     *
     * @return self
     */
