...
class ResourceNotFoundProblem extends Problem
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceNotFoundProblem';
    ...
    public function setParameter($parameter)
    {
        ...
        if ((mb_strlen($parameter) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parameter when calling ResourceNotFoundProblem., must be bigger than or equal to 1.');
        }
